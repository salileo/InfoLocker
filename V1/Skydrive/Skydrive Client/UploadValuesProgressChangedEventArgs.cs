...
{
    /// <summary>
    /// Provides data for the <see cref="E:UploadValuesProgressChanged"/> event of a <see cref="HttpWebClient"/>.
    /// </summary>
    internal class UploadValuesProgressChangedEventArgs : EventArgs
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadValuesProgressChangedEventArgs"/> class.
        /// </summary>
        ...
        internal UploadValuesProgressChangedEventArgs(long bytesSent, long totalBytesToSent)
        {
            BytesSent = bytesSent;
