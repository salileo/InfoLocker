    ...
    public class Updater
    {
        ...
        static void worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string msg = "An update of " + info.productName + " is available online. Select OK to continue to install the update.";
                    MessageBoxResult result = MessageBox.Show(msg, "Updater", MessageBoxButton.OKCancel, MessageBoxImage.Information);
